        ...
        {type === 'bitcoin' && (
          <div className='h-16 flex flex-row justify-start items-center px-12'>
            ...
            <div className='flex flex-col justify-center items-start ml-2'>
              <p className='text-white text-sm font-semibold'>{satoshisToBTC(item)} BTC</p>
            </div>
          </div>
        )}
        {type === 'inscription' && (
          <div className='h-full w-full flex flex-row justify-start items-center px-16'>
            {!content ? (
              ...
              <>
                <InscriptionContent inscription={content} size='xs' className='-ml-8' />
                <div className='flex flex-col justify-center items-start'>
                  <p className='text-white text-sm font-semibold'>{truncateAddress(content.id)}</p>
              </div>
              </>
            )}
          </div>
